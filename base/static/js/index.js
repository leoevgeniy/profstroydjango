...
function fontsize() {
    ...
    // let modalHeader = document.querySelector('.modal .modal-header')
    // modalTitle.style.fontSize = modalHeader.offsetWidth / 2
    // block.forEach((info) => {
    ...
    // button.style.marginTop = button.parentElement.offsetWidth * 0.04
    // button.style.width = button.parentElement.offsetWidth * 0.54
    // button.style.height = button.parentElement.offsetWidth * 0.14
    // button.style.fontSize = button.parentElement.offsetWidth * 0.05
    // let skidkabutton = document.querySelector('.skidka-button');
    // skidkabutton.style.marginTop = skidkabutton.parentElement.offsetWidth * 0.1
    // skidkabutton.style.width = skidkabutton.parentElement.offsetWidth /2
    // skidkabutton.style.height = skidkabutton.parentElement.offsetWidth *0.1
    // skidkabutton.style.fontSize = skidkabutton.parentElement.offsetWidth * 0.05
    // let skidka = document.querySelectorAll('.skidka')
    // skidka.forEach(ski => {
    //     ski.style.fontSize = ski.parentElement.offsetWidth * 0.07
    //     ski.style.marginTop = ski.parentElement.offsetWidth * 0.07
    // })
    // const footertitle = document.querySelector('footer .title')
    // footertitle.style.fontSize = footertitle.parentElement.offsetWidth * 0.04
    // footertitle.style.marginLeft = footertitle.parentElement.offsetWidth * 0.04
    // const contactstitle = document.querySelectorAll('footer .p-title')
    // contactstitle.forEach(title => {
    //     title.style.fontSize = document.querySelector('footer').offsetWidth * 0.04
    //
    // })
    // const contactsp = document.querySelectorAll('footer .p-footer')
    // contactsp.forEach(title => {
    //     title.style.fontSize = contactstitle[0].offsetWidth * 0.08
    //
    // })
